...
const LibraryPage: React.FC = () => {
  ...
  const handleScan = async () => {
    try {
      ...
      showToast('Library scan started. Files are only read; database records are updated.');
    } catch (err) {
      console.error(err);
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            title="Scan library folders. This reads archives and updates the database without modifying source files."
          >
